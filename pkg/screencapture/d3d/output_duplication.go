...
func (dup *OutputDuplicator) Bounds() image.Rectangle {
	return dup.rect
}
...
func (dup *OutputDuplicator) GetImage(img *image.NRGBA, timeoutMs uint) error {
...
func (dup *OutputDuplicator) drawPointer(img *image.NRGBA) error {
	if !dup.DrawPointer {
		return nil
	}
